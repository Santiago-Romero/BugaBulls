...
import com.bugabulls.controlador.UpdateAsignarCategoriaIn;
...
public class AsignarCategoriaIn extends JDialog {
	...
	public AsignarCategoriaIn(MenuAdministrador ma) {
                setModal(true);
		...
		JLabel jlTitulo = new JLabel("Asignar Categor\u00EDa Infantiles");
		...
		jtCategoria.setText("Infantiles");
		...
		jlerror.setBounds(00, 307, 650, 27);
		 getContentPane().add(jlerror);
                ...
                UpdateAsignarCategoriaIn aci = new UpdateAsignarCategoriaIn(this);
                jbGuardar.addActionListener(aci);
	}
