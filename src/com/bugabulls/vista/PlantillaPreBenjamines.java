...
public class PlantillaPreBenjamines extends JDialog {
	...
	public PlantillaPreBenjamines(MenuAdministrador ma) {
            setModal(true);
		...
		JLabel jlTitulo = new JLabel("Plantilla PreBenjamines");
