...
import com.bugabulls.controlador.UpdateAsignarCategoriaPre;
...
public class AsignarCategoriaPre extends JDialog {
	...
	public AsignarCategoriaPre(MenuAdministrador ma) {
                setModal(true);
		...
		JLabel jlTitulo = new JLabel("Asignar Categor\u00EDa Pre Benjamines");
		...
		jtCategoria.setText("Pre Benjamines");
		...
		jlerror.setBounds(00, 307, 650, 27);
		 getContentPane().add(jlerror);
                ...
                UpdateAsignarCategoriaPre acp = new UpdateAsignarCategoriaPre(this);
                jbGuardar.addActionListener(acp);
	}
