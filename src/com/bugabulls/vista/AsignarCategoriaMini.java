...
import com.bugabulls.controlador.UpdateAsignarCategoriaMini;
...
public class AsignarCategoriaMini extends JDialog {
	...
	public AsignarCategoriaMini(MenuAdministrador ma) {
                setModal(true);
		...
		JLabel jlTitulo = new JLabel("Asignar Categor\u00EDa Minis");
		...
		jlerror.setBounds(00, 307, 650, 27);
		 getContentPane().add(jlerror);
                ...
                UpdateAsignarCategoriaMini acm = new UpdateAsignarCategoriaMini(this);
                jbGuardar.addActionListener(acm);
	}
