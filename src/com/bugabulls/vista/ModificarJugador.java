...
import com.bugabulls.controlador.UpdateModificarJugador;
...
public class ModificarJugador extends JDialog {
	public JTextField jtNombre,jtApellidos,jtDireccion,jtEps,jtTelefono,jtAltura,jtDni;
	public JTextField jtCategoria,jtCedulaFamiliar,jtNombreFamiliar,jtApellidosFamiliar;
	public JTextField jtParentescoFamiliar,jtTelefonoFamiliar,jtDireccionFamiliar,jtCodigo,jtContrasena;
	public JTextField jtCodigoModificar;
	public JButton jbBuscar,jbModificar,jbBuscarAcu;
        public JButton jbAgregarFoto;
        public JDateChooser jdFechaNacimiento;
        public JLabel jlFotoPerfil;
        public JLabel jlerrorBuscar;
        public JLabel jlerrorBuscarAcu;
        public JLabel jlerror;
        
	public ModificarJugador(MenuAdministrador ma) {
		setModal(true);
	...
	public void CrearGui(){
		...
		panel.setPreferredSize(new Dimension(650, 1050));
		...
		JLabel jlCodigoModificar = new JLabel("Código Jugador");
		jlCodigoModificar.setFont(new Font("Tahoma", Font.PLAIN, 16));
		jlCodigoModificar.setBounds(26, 59, 122, 25);
		panel.add(jlCodigoModificar);
		
		JPanel panelDatosPersonales = new JPanel();
		panelDatosPersonales.setBounds(26, 162, 596, 334);
		...
		jlTituloDatosPersonales.setBounds(26, 110, 596, 34);
		...
		jlDatosFamiliares.setBounds(26, 513, 596, 34);
		...
		panelDatosFamiliares.setBounds(26, 553, 596, 220);
		...
		jtCedulaFamiliar.setColumns(10);
                jtCedulaFamiliar.setDocument(new LimitadorCaracteres(jtCedulaFamiliar, 11, 0));
		...
		jtTelefonoFamiliar.setBounds(117, 146, 195, 27);
                jtTelefonoFamiliar.setDocument(new LimitadorCaracteres(jtTelefonoFamiliar, 11, 0));
		...
		jlDatosSesion.setBounds(26, 800, 596, 34);
		...
		panelDatosSesion.setBounds(26, 850, 596, 89);
		...
		jbBuscar.setBounds(360, 59, 111, 25);
		panel.add(jbBuscar);
		...
		jlerrorBuscar.setBounds(479, 59,100, 27);
		panel.add(jlerrorBuscar);
                
                jbBuscarAcu = new JButton("Buscar");
		jbBuscarAcu.setBackground(new Color(95, 158, 160));
		jbBuscarAcu.setFont(new Font("SansSerif", Font.PLAIN, 14));
		jbBuscarAcu.setBounds(328, 11, 97, 24);
                panelDatosFamiliares.add(jbBuscarAcu);
                
                jlerrorBuscarAcu = new JLabel("");
                jlerrorBuscarAcu.setHorizontalAlignment(SwingConstants.CENTER);
                jlerrorBuscarAcu.setForeground(new Color(255, 0, 0));
                jlerrorBuscarAcu.setFont(new Font("Tahoma", Font.PLAIN, 16));		
		jlerrorBuscarAcu.setBounds(433, 11, 100, 25);
		panelDatosFamiliares.add(jlerrorBuscarAcu);
		...
		jlerror.setBounds(10, 1000, 650, 27);
		panel.add(jlerror);
                
		
                UpdateModificarJugador moj = new UpdateModificarJugador(this);
                jbModificar.addActionListener(moj);
                jbBuscar.addActionListener(moj);
                jbBuscarAcu.addActionListener(moj);
                jbAgregarFoto.addActionListener(moj);
