...
import com.bugabulls.controlador.UpdateModificarAdministrador;
...
public class ModificarAdministrador extends JDialog {
	...
	public ModificarAdministrador(MenuAdministrador ma) {
                setModal(true);
	...
	public void CrearGui(){
		JLabel jlFichaEntrenador = new JLabel("Ficha Administrador");
		...
		jbBuscar.setBounds(405, 70, 111, 25);
		...
		jlerrorBuscar.setBounds(518, 70, 100, 27);
		...
		getContentPane().add(jlerror);
                ...
                UpdateModificarAdministrador moa = new UpdateModificarAdministrador(this);
                jbModificar.addActionListener(moa);
                jbBuscar.addActionListener(moa);
}}
