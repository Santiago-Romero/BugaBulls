...
import com.bugabulls.controlador.UpdateAsignarCategoriaJunior;
...
public class AsignarCategoriaJunior extends JDialog {
	...
	public AsignarCategoriaJunior(MenuAdministrador ma){
                setModal(true);
		...
		JLabel jlTitulo = new JLabel("Asignar Categor\u00EDa Junior");
		...
		jlerror.setBounds(00, 307, 650, 27);
		 getContentPane().add(jlerror);
                ...
                UpdateAsignarCategoriaJunior acj = new UpdateAsignarCategoriaJunior(this);
                jbGuardar.addActionListener(acj);
	}
